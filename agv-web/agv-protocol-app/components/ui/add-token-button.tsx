...
interface TokenMeta {
  ...
  symbol: string;
  decimals: number;
  iconUrl: string; // absolute https URL, publicly accessible
}
...
const TOKENS: Record<string, TokenMeta> = {
  pGVT: {
    ...
    symbol: "pGVT",
    decimals: 18,
    iconUrl: "https://www.agvnexrur.ai/pGVT_128.png",
  },
  sGVT: {
    address: "0x53e599211bF49Aa2336C3F839Ad57e20dE3662a3",
    symbol: "sGVT",
    decimals: 18,
    iconUrl: "https://www.agvnexrur.ai/sGVT_128.png",
  },
};
...
async function addTokenWithIcon(
  ...
  try {
    ...
    // User rejected connection — can’t proceed
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      >
        ...
        <img src={`/${tokenKey}_128.png`} alt={token.symbol} width={20} height={20} className="rounded-full" />
