...
contract DeploySeedPass is Script {
    ...
    function testDeployedContract(address proxyAddress) internal view {
        ...
        uint256 remainingWhitelist = seedpass.getRemainingWhitelistSupply();
        ...
        console.log("Remaining Whitelist:", remainingWhitelist);
...
contract ConfigureSeedPass is Script {
    function run() external {
        ...
        console.log("Remaining Whitelist Supply:", seedpass.getRemainingWhitelistSupply());
