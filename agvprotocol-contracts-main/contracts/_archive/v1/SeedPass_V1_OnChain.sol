...
// Contract: SeedPass (Implementation behind UUPS Proxy)
// Address (Implementation): 0x24ac1751394c74ecd72ccdb33fc5767ca53cdfe0
// Address (Proxy): 0xFF362C39eB0eDecA946A5528d30D9c9E9285f3fc  (contracts.ts)
...
//
// Diff vs Local (contracts/nft/SeedPass.sol):
...
//   4. supportsInterface: super → explicit multi-ERC chain
//   (SeedPass 无 Agent 功能差异 — 本地版本也未添加 IAgentRegistry)
//   Local is newer version (post-deployment updates, not yet upgraded on-chain)
//
// Note: SeedPass is the ONLY Pass whose proxy is still alive and verified.
//   The other 3 Passes (Tree/Solar/Compute) have empty or dead proxies.
//
// Strategic Purpose:
//   SeedPass 是 AGV Protocol 的入门级 NFT Pass (600 总量, $29.9/枚)。
//   使用 ERC721A + UUPS Proxy 模式，支持白名单和公开两阶段铸造。
//   USDT 支付 (1e18 精度)，版税 3%。已有 17 枚流通。
// ============================================================================
    ...
    PausableUpgradeable
{
    ...
    uint256 internal constant PRICE_USDT = 29 * 1e18;
