...
// Contract: ComputePass (Implementation behind UUPS Proxy)
// Address (Implementation): 0x9981d0b53544db2ebe69c3bbeb5299d8985044f2
// Address (Proxy): 0x6F503f315c95835A68d140440CA49b5C3e885Ce3
...
//
// Diff vs Local (contracts/nft/ComputePass.sol):
...
//
// Strategic Purpose:
//   ComputePass 是 AGV Protocol 的最高级 NFT Pass (99 总量, $899/枚)。
    ...
    PausableUpgradeable
{
    ...
    uint256 internal constant WL_PRICE_USDT = 899 * 1e18;
    uint256 internal constant PUBLIC_PRICE_USDT = 899 * 1e18;
    uint256 internal constant AGENT_PRICE_USDT = 499 * 1e18;
