...
// Contract: TreePass (Implementation behind UUPS Proxy)
// Address (Implementation): 0x068add54f8a58c33ad7aba26582d25329b19a185
// Address (Proxy): 0x1E092126E4AB12503d37dD08E20F9192b8439458
...
//
// Diff vs Local (contracts/nft/TreePass.sol):
...
//   (TreePass 无 Agent 功能差异 — 本地版本也未添加 IAgentRegistry)
//   Local is newer version (post-deployment updates, not yet upgraded on-chain)
//
// Strategic Purpose:
//   TreePass 是 AGV Protocol 的中级 NFT Pass (300 总量, $59/枚)。
//   使用 ERC721A + UUPS Proxy 模式，支持白名单和公开两阶段铸造。
//   USDT 支付 (1e18 精度)，版税 5%。已有 1 枚流通。
// ============================================================================
    ...
    PausableUpgradeable
{
    ...
    uint256 internal constant WL_PRICE_USDT = 59 * 1e18;
    uint256 internal constant PUBLIC_PRICE_USDT = 59 * 1e18;
